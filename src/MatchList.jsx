...
const handleSubmit = async (e) => {
  ...
  return (
    <div style={{ backgroundColor: "#0A0F1E", color: "#E8F4FF", minHeight: "100vh", padding: "20px", fontFamily: "sans-serif" }}>
      ...
      {/* ヘッダー */}
      <header style={{ borderBottom: "2px solid #00A0E9", paddingBottom: "10px", marginBottom: "30px" }}>
        <h1 style={{ margin: 0, color: "#00A0E9" }}>川崎フロンターレ 2026 Analysis</h1>
      </header>
